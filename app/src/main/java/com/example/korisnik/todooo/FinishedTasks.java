...
public class FinishedTasks extends AppCompatActivity {
    ...
    private static final String TAG = "FinishedTasks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskoviView = (ListView) findViewById(R.id.taskovi_finished);
        ...
        taskoviView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(FinishedTasks.this, EditTaskFromFinishedTasks.class);
    ...
    private void updateUI(){
        ...
        // Query the database
        Cursor cursor = db.rawQuery("SELECT  t." + Task.TaskEntry._ID + " FROM Task t, Lista l WHERE t.id_lista = l._id AND l.type == 1 AND status = ? ORDER BY date == ''", new String[]{q});
