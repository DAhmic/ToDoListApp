...
public class EditTaskFromAllTaskSortByPriority extends AppCompatActivity implements View.OnClickListener {
    private DrawerLayout drawerLayout;
    private ActionBarDrawerToggle actionBarDrawerToggle;
    private NavigationView nvDrawer;

    private static final String TAG = "EditTaskFromAllTaskSortByPriority";
    ...
    public void onClick(View v) {
        ...
        if (editTaskButton.isPressed()) {
            ...
            Intent intent = new Intent(this, AllTaskSortByPriority.class);
